...
static struct module_pin_mux lcd_pin_mux[] = {
        ...
        {OFFSET(gpmc_ad14), (MODE(7) | PULLUDEN)},   /* GPIO1_14 */     //-->KM-LCD_D6
        {OFFSET(gpmc_ad15), (MODE(7) | PULLUDEN)},   /* GPIO1_15 */     //-->KM-LCD_D7
        ...
        {OFFSET(lcd_data13), (MODE(7))},             /* lcd_data13 */ // By default disable Buzzer
        {OFFSET(lcd_data14), (MODE(7))},             /* lcd_data14 */ // By default disable USER LED
        {OFFSET(lcd_data15), (MODE(7))},             /* lcd_data15 */ // Bydefault disable USER SW
...
static struct module_pin_mux i2c1_pin_mux[] = {
         {OFFSET(spi0_d1), (MODE(2) | RXACTIVE |
                         PULLUDEN | SLEWCTRL)}, /* I2C1_DATA */
         {OFFSET(spi0_cs0), (MODE(2) | RXACTIVE |
                         PULLUDEN | SLEWCTRL)}, /* I2C1_SCLK */
         {-1},
};
...
static struct module_pin_mux can0_pin_mux[] = {
	{OFFSET(uart1_ctsn), (MODE(2) | RXACTIVE |PULLUP_EN | PULLUDEN )},	/* uart1_ctsn */ //KM-CAN0-TX
	{OFFSET(uart1_rtsn), (MODE(2) | RXACTIVE |PULLUP_EN | PULLUDEN )},	/* uart1_rtsn */ //KM-CAN0-RX
	{-1},
};
...
/*###############################################################################################
 The below mux/pad configuration for other beagle bone variants
#################################################################################################*/
